...
<div id="login" class="container">
    <div class="hero-unit">
        <div class="pull-left login-left" style="width: 300px">
        ...
        <div class="pull-left login-right">
            ...
            <?php include_partial('signin_form', array('form' => $form, 'routes' => $sf_context->getRouting()->getRoutes(), 'change_password' => isset($change_password) ? $change_password : 0)) ?>
        </div>
